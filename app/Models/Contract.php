...
class Contract extends Model
{
    ...
    {
        if (!empty($value) == 'on' || !empty($value) == true) {
    ...
    {
        if (!empty($value) == '1') {
            $this->attributes['owner_spouse'] = 1;
        } else {
            $this->attributes['owner_spouse'] = 0;
        }
    }
    ...
    {
        if (!empty($value) == '1') {
            $this->attributes['acquirer_spouse'] = 1;
        } else {
            $this->attributes['acquirer_spouse'] = 0;
        }
    }
    ...
    {
        $this->attributes['tribute'] = $this->convertStringToDouble($value);
    }
    ...
    {
        $this->attributes['condominium'] = $this->convertStringToDouble($value);
    }
