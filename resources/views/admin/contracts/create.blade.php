...
@section('content')
    ...
    <div class="content-header ">
        <div class="container-fluid my-4">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="fa fa-plus-circle"></i> Cadastro de Contratos</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="btn btn-primary" href="{{route('admin.contracts.index')}}">
    ...
    <form action="{{ route('admin.contracts.store') }}" method="post" enctype="multipart/form-data" class="col-12">
        @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <select name="status" class="form-control" id="status">
                                    ...
                                    <option value="canceled" {{ (old('status') == 'canceled' ? 'selected' : '') }}>Indisponível</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="date" class="form-control" id="start_at" name="start_at"
                                       placeholder="Data de Início" value="{{ old('start_at') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3 tab-pane fade" id="terms" role="tabpanel" aria-labelledby="terms-tab">
                <div class="card card-default col-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label for="terms">Descrição do Imóvel:</label>
                                <textarea name="terms" cols="30" rows="10" class="mce"
                                          id="terms">{{ old('terms') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
