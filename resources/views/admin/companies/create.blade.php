...
@section('content')
    ...
    <div class="content-header ">
        <div class="container-fluid my-4">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="fa fa-plus-circle"></i> Cadastro de Empresas</h1>
                </div>
                <div class="col-sm-6">
    ...
    @endif
    <form action="{{route('admin.companies.store')}}" class="col-12" method="post">
        @csrf
        <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <select name="user" id="user" class="form-control">
                                ...
                                @foreach($users as $user)
                                    <option
                                        value="{{$user->id}}" {{old('user') ? 'selected' : ($user->user ? 'selected' : '')}}>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control" id="social_name"
                                   name="social_name" placeholder="Razão Social" value="{{old('social_name') ?? ''}}">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="zipcode">*Nome Fantasia:</label>
                            <input type="text" class="form-control" id="alias_name"
                                   name="alias_name" placeholder="Nome Fantasia" value="{{old('alias_name') ?? ''}}">
                        </div>
                        <div class="form-group col-lg-6">
