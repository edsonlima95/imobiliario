...
@section('content')
    ...
    <div class="content-header ">
        <div class="container-fluid my-4">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="fa fa-edit"></i> Edição de Imóveis</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="btn btn-success" href="{{route('admin.properties.create')}}">
                ...
                <nav class="navbar navbar-light bg-dark my-3 p-3 justify-content-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="lessee"
                               name="rent" {{old('rent') == 'on' || old('rent') == true ? 'checked' : ($property->rent == true ? 'checked' : '')}}>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="status" class="form-control" id="status">
                                    <option
                                        value="1" {{ (old('status') == '1' ? 'selected' : ($property->status == true ? 'selected' : '')) }}>
                                        Disponível
                                    </option>
                                    <option
                                        value="0" {{ (old('status') == '0' ? 'selected' : ($property->status == false ? 'selected' : '')) }}>
                                        Indisponível
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="number" name="number"
                                       placeholder="Número do Endereço" value="{{ old('number') ?? $property->number}}">
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control" id="bedrooms"
                                       name="bedrooms" placeholder="Quantidade de Dormitórios"
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control" id="area_total"
                                       name="area_total" placeholder="Quantidade de M&sup2;"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 d-flex flex-column">
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="air_conditioning" {{ (old('air_conditioning') == 'on' || old('air_conditioning') == true ? 'checked' : ($property->air_conditioning == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Ar Condicionado</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="bar" {{ (old('bar') == 'on' || old('bar') == true ? 'checked' : ($property->bar == true ? 'checked' : ''))  }}>
                                    <label class="form-check-label" for="lessor">Bar</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="library" {{ (old('library') == 'on' || old('library') == true ? 'checked' : ($property->library == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Biblioteca</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="barbecue_grill" {{ (old('barbecue_grill') == 'on' || old('barbecue_grill') == true ? 'checked' : ($property->barbecue_grill == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Churrasqueira</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="steam_room" {{ (old('steam_room') == 'on' || old('steam_room') == true ? 'checked' : ($property->steam_room == true ? 'checked' : '')) }}>
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                ...
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="american_kitchen" {{ (old('american_kitchen') == 'on' || old('american_kitchen') == true ? 'checked' : ($property->american_kitchen == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Cozinha Americana</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="fitted_kitchen" {{ (old('fitted_kitchen') == 'on' || old('fitted_kitchen') == true ? 'checked' : ($property->fitted_kitchen == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Cozinha Planejada</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="pantry" {{ (old('pantry') == 'on' || old('pantry') == true ? 'checked' : ($property->pantry == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Despensa</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="edicule" {{ (old('edicule') == 'on' || old('edicule') == true ? 'checked' : ($property->edicule == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Edícula</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="office" {{ (old('office') == 'on' || old('office') == true ? 'checked' : ($property->office == true ? 'checked' : '')) }}>
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="bathtub" {{ (old('bathtub') == 'on' || old('bathtub') == true ? 'checked' : ($property->bathtub == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Banheira</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="fireplace" {{ (old('fireplace') == 'on' || old('fireplace') == true ? 'checked' : ($property->fireplace == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Lareira</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="lavatory" {{ (old('lavatory') == 'on' || old('lavatory') == true ? 'checked' : ($property->lavatory == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Lavabo</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="furnished" {{ (old('furnished') == 'on' || old('furnished') == true ? 'checked' : ($property->furnished == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Mobiliado</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="lessor"
                                           name="pool" {{ (old('pool') == 'on' || old('pool') == true ? 'checked' : ($property->pool == true ? 'checked' : '')) }}>
                                    <label class="form-check-label" for="lessor">Piscina</label>
                                </div>
                                <div class="form-check form-check-inline mr-5">
                                    <input class="form-check-input" type="checkbox" id="view_of_the_sea"
                                           name="view_of_the_sea" {{ (old('view_of_the_sea') == 'on' || old('view_of_the_sea') == true ? 'checked' : ($property->view_of_the_sea == true ? 'checked' : '')) }}>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="zipcode"
                                       name="title"
                                       placeholder="Digite o Titulo" value="{{old('title') ?? $property->title}}">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="headline">Headline:</label>
                                <input type="text" class="form-control" id="headline"
                                       name="headline"
                                       placeholder="Digite o Titulo" value="{{old('headline') ?? $property->headline}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="content_image d-flex flex-wrap">
                                    @foreach($property->images()->get() as $image)
                                        <div class="property_image_item mr-2 mb-2">
                                            <img style="width: 238px; height: 137px" src="{{ $image->url_cropped }}"
                                                 alt="">
                                            <a data-toggle="tooltip" data-placement="top" title="Setar como capa"
                                               data-action="{{route('admin.properties.imageSetCover',['id'=>$image->id])}}"
                                               class="{{$image->cover == true ? 'btn-action-image btn-set-cover-green' : 'btn-action-image'}}"><i class="fa fa-check"></i></a>

                                            <a data-toggle="tooltip" data-placement="top" title="Remover Imagem"
                                               data-action="{{route('admin.properties.imageRemove',['id'=>$image->id])}}"
...
@section('js')
    <script>
        $(function () {
                ...
                $.each(files.target.files, function (key, value) {
                    ...
                    reader.onload = function (value) {
                        $('.content_image').append(
                            '<div class="property_image_item mr-3">' +
            ...
            //SETA A FOTO COMO CAPA DO IMOVEL.
            $('a.btn-action-image').on('click', function (event) {
                ...
                $.post(button.data('action'), {}, function (response) {
                    if(response.success === true){
                        $('.property_image_item').find('a.btn-set-cover-green').removeClass('btn-set-cover-green');
                        button.addClass('btn-set-cover-green');
                    }
                }, 'json');
            })

            //REMOVE A IMAGEM DO IMOVEL
            $('a.btn-remove').on('click', function (event) {
                event.preventDefault();
