...
@section('content')
    ...
    <div class="content-header ">
        <div class="container-fluid my-4">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="fa fa-edit"></i> Edição de Clientes</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="tab-content" id="myTabContent">
                ...
                <nav class="navbar navbar-light bg-dark my-3 p-3 justify-content-start">
                    ...
                    <div class="form-check form-check-inline mr-5">
                        <input class="form-check-input" type="checkbox" id="lessor"
                               name="lessor" {{old('lessor') == 'on' || old('lessor') == true ? 'checked' : ($user->lessor == true ? 'checked' : '')}}>
                        <label class="form-check-label" for="lessor">Locatário</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="lessee"
                               name="lessee" {{old('lessee') == 'on' || old('lessee') == true ? 'checked' : ($user->lessee == true ? 'checked' : '')}}>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control mask-doc" id="document" name="document"
                                       ...
                                       value="{{old('document') ? old('document') : $user->document}}">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="document_secondary">RG:</label>
                                <input type="text" class="mask-doc-secondary form-control" id="document_secondary"
                                       name="document_secondary"
                                       placeholder="RG do Cliente"
                                       value="{{old('document_secondary') ? old('document_secondary') : $user->document_secondary}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="document_secondary_complement"
                                       ...
                                       value="{{old('document_secondary_complement') ? old('document_secondary_complement') : $user->document_secondary_complement}}">
                            </div>
                            <div class="form-group col-lg-6">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="place_of_birth" name="place_of_birth"
                                       ...
                                       value="{{old('place_of_birth') ? old('place_of_birth') : $user->place_of_birth}}">
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="occupation" name="occupation"
                                       ...
                                       value="{{old('occupation') ?  old('occupation') : $user->occupation}}">
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control zip_code_search mask-zipcode" id="zipcode"
                                       name="zipcode" placeholder="Digite o CEP"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="complement" name="complement"
                                       ...
                                       value="{{old('complement') ? old('complement') : $user->complement}}">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="neighborhood">*Bairro:</label>
                                <input type="text" class="form-control" id="neighborhood" name="neighborhood"
                                       placeholder="Bairro"
                                       value="{{old('neighborhood') ? old('neighborhood') : $user->neighborhood}}">
                            </div>
                            <div class="form-group col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control mask-phone" id="cell" name="cell"
                                       class="mask-cell"
                                       placeholder="Número do Telefonce com DDD"
                                       value="{{old('cell') ? old('cell') : $user->cell}}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3 tab-pane fade" id="conjugue" role="tabpanel" aria-labelledby="conjugue-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control" id="spouse_name" name="spouse_name"
                                       placeholder="Nome Completo"
                                       value="{{old('spouse_name') ? old('spouse_name') : $user->spouse_name}}">
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control mask-doc" id="spouse_document"
                                       ...
                                       placeholder="CPF do Cliente"
                                       value="{{old('spouse_document') ? old('spouse_document') : $user->spouse_document}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control mask-doc-secondary"
                                       ...
                                       value="{{old('spouse_document_secondary') ? old('spouse_document_secondary') : $user->spouse_document_secondary}}">
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="document_secondary_complement">*Órgão Expedidor:</label>
                                <input type="text" class="form-control" id="document_secondary_complement"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="date" class="form-control" id="spouse_date_of_birth"
                                       ...
                                       placeholder="Data de Nascimento"
                                       value="{{old('spouse_date_of_birth') ? old('spouse_date_of_birth') : $user->spouse_date_of_birth}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="spouse_place_of_birth"
                                       ...
                                       placeholder="Cidade de Nascimento"
                                       value="{{old('spouse_place_of_birth') ? old('spouse_place_of_birth') : $user->spouse_place_of_birth}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="spouse_occupation" name="spouse_occupation"
                                       placeholder="Profissão do Cliente"
                                       value="{{old('spouse_occupation') ? old('spouse_occupation') : $user->spouse_occupation}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control mask-money" id="spouse_income"
                                       name="spouse_income"
                                       placeholder="Valores em Reais"
                                       value="{{old('spouse_income') ? old('spouse_income') : $user->spouse_income}}">
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" id="spouse_company_work"
                                       ...
                                       placeholder="Contratante"
                                       value="{{old('spouse_company_work') ? old('spouse_company_work') : $user->spouse_company_work}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-default col-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if(!empty($user->companies()->get()))
                                @foreach($user->companies()->get() as $company)
                                    <dl>
                                        <dt>Razão Social:</dt>
                                        <dd>{{$company->social_name}}</dd>
                                        <dt>Nome Fantasia:</dt>
                                        <dd>{{$company->alias_name}}
                                        </dd>
                                        <dt>CNPJ:</dt>
                                        <dd>{{$company->document_company}}</dd>
                                        <dt>Inscrição Estadual:</dt>
                                        <dd>{{$company->document_company_secondary}}</dd>
                                        <dt>Endereço:</dt>
                                        <dd>
                                            <ul class="list-unstyled">
                                                <li>CEP: {{$company->zipcode}} </li>
                                                <li>Endereço: {{$company->street}}</li>
                                                <li>Bairro: {{$company->neighborhood}}</li>
                                                <li>Cidade: {{$company->city}}</li>
                                                <li>Estado: {{$company->state}}</li>
                                            </ul>
                                        </dd>
                                    </dl>
                                @endforeach
